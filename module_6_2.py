class Vehicle:
    ...
    def __init__(self, owner1, model1, color1, engine_power1):
        self.owner = owner1
        self.__model = model1
        self.__engine_power = engine_power1
        self.__color = color1
    ...
    def print_info(self):
        ...
        print(f"Владелец: \033[32m{self.owner}")
    ...
    def set_color(self, new_color):
        ...
        for i in self.__COLOR_VARIANTS:
            if i.upper() == new_color.upper():
                r = 1
                self.__color = "\033[32m" + new_color + "\033[34m"
        if r == 0:
...
class Sedan(Vehicle):
    ...
    def __init__(self, owner1, model1, color1, engine_power1):
        # self.owner = owner1
        super().__init__(owner1, model1, color1, engine_power1)
        # self._model = model1
